  ...
  <>
   ...
   <div className='md:hidden'>
    <Slider {...settings}>
     <div className='h-96 rounded-l-md bg-primar/80'>
      <div className='flex flex-row h-full w-full'>
       <div className='w-1/3 h-full bg-cabes2 bg-cover bg-center rounded-r-[170px]' />
       <div className='w-2/3 py-5 px-3 flex flex-col gap-2 justify-center items-center'>
        <p className='text-lg font-bold text-white'>Estamos a mais de 28 anos no mercado de tecnologia</p>
     ...
     <div className=' h-96 bg-gradient-to-r from-primar/80  to-green1 '>
      <div className='w-full h-full py-12 px-4 flex flex-col gap-3 relative'>
       <p className='text-lg font-bold text-white'>Não perca mais o seu tempo!</p>
       <div className='w-full h-full flex flex-col gap-9 justify-center'>
        <p className='text-base font-medium text-white'>
         Garantimos que você receba o que há de melhor em tecnologia para voz, dados, imagens, controle de acesso e energia{' '}
        </p>
        <p className='w-full text-base font-medium text-white'>
         Eficiência, segurança e inovação para o seu negócio. Confie em quem entende do assunto. Confie na Solemar Telecom.
        </p>
       </div>
      </div>
     ...
     <div className={`h-96 rounded-r-md bg-green1`}>
      <div className='flex flex-row h-full w-full'>
       <div className='w-2/3 py-5 px-3 flex flex-col gap-3 justify-center items-center'>
        <p className='text-lg font-bold text-white'>Temos o orgulho de ser autorizados e certificados pela Intelbras</p>
        <p className='text-sm font-medium text-white'>
         Essa parceria garante que nossos serviços e produtos atendem aos mais altos padrões de qualidade e inovação, proporcionando segurança,
         conectividade e eficiência para nossos clientes.
        </p>
       </div>
       <div className='w-1/3 h-full bg-equipment bg-cover bg-center rounded-l-[170px]' />
      </div>
     </div>
    </Slider>
   </div>
