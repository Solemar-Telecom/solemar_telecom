  ...
  <div className='bg-primar/10'>
   ...
   <div class='px-32 max-md:px-10 mb-11 flex flex-col gap-16 pt-32'>
    ...
    <div className='flex items-center gap-14'>
     ...
     <div className='flex flex-col gap-16 max-md:gap-5'>
      <div className='flex flex-col gap-4 max-md:gap-0'>
       <p className='text-4xl max-md:text-xl font-bold'>Na Solemar Telecom, estamos ao seu lado em cada passo do caminho</p>
    ...
    <div className='flex flex-col gap-4'>
     <p className='text-3xl max-md:text-base font-bold '>Onde você pode utilizar nossos serviços ?</p>
    ...
    <div className='flex flex-col gap-4 px-36 py-4 max-md:p-0'>
     <p className='text-3xl max-md:text-xl font-bold text-center'>Somos mais do que um fornecedor de serviços</p>
     <p className='text-xl max-md:text-lg text-center'>
    ...
    <div className='flex flex-col gap-4'>
     <div className='flex justify-end gap-3'>
      <p className='text-3xl max-md:text-xl font-bold text-right'>Quais são os nossos serviços ?</p>
      <Button />
     </div>
     <div className='flex flex-col gap-3'>
      <div className='flex gap-3'>
       <div
        className=' flex w-3/4 max-md:w-2/4 h-80 cursor-pointer bg-facesRanders bg-cover bg-center rounded-md'
        onClick={() => {
         navigate('/solutions/condos');
        }}
       >
        <div className='w-full h-full flex items-center justify-center hover:bg-black/50 duration-1000 rounded-md'>
         <p className='text-4xl max-md:text-lg max-md:text-center font-bold text-white'>CONTROLE DE ACESSO</p>
        </div>
       </div>
       <div
        className=' flex w-1/4 max-md:w-2/4 h-80 cursor-pointer bg-cabes bg-cover bg-center rounded-md'
        onClick={() => {
         navigate('/solutions/companies');
        }}
       >
        <div className='w-full h-full flex items-center justify-center hover:bg-black/50 duration-1000 rounded-md'>
         <p className='text-4xl max-md:text-lg font-bold text-white'>REDES</p>
        </div>
       </div>
      </div>
      <div className='flex gap-3'>
       <div
        className=' flex w-1/4 max-md:w-2/4 h-80 cursor-pointer bg-cams bg-cover bg- rounded-md'
        onClick={() => {
         navigate('/solutions/condos');
        }}
       >
        <div className='w-full h-full flex items-center justify-center hover:bg-black/50 duration-1000 rounded-md'>
         <p className='text-4xl max-md:text-lg font-bold text-white'>CÂMERAS</p>
        </div>
       </div>
       <div
        className=' flex w-3/4 max-md:w-2/4 h-80 cursor-pointer bg-solar bg-cover bg-center rounded-md'
        onClick={() => {
         navigate('/solutions/energy');
        }}
       >
        <div className='w-full h-full flex items-center justify-center hover:bg-black/50 duration-1000 rounded-md'>
         <p className='text-4xl max-md:text-lg max-md:text-center font-bold text-white'>ENERGIA SOLAR</p>
        </div>
       </div>
      </div>
     </div>
