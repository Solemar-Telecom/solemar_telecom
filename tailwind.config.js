 ...
 theme: {
  extend: {
   ...
   backgroundImage: {
    ...
    faceRander: "url('/src/images/jpg/FaceRender.jpg')",
    faceRander2: "url('/src/images/png/FaceRender2.png')",
    facesRanders: "url('/src/images/jpg/FacesRenders.jpg')",
    ...
    fleet: "url('/src/images/jpg/Fleet.jpg')",
